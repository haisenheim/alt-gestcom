      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item {{ $active==1?'active':'' }}">
            <a href="/laboratoire/dashboard" class="nav-link {{ $active==1?'active':'' }}">
          ...
          <li class="nav-item {{ $active==3?'active':'' }}">
            <a href="/laboratoire/factures" class="nav-link {{ $active==4?'active':'' }}">
          ...
          <li class="nav-item {{ $active==4?'active':'' }}">
            <a href="/laboratoire/prestations" class="nav-link {{ $active==4?'active':'' }}">
              <i class="nav-icon fas fa-file-pdf"></i>
              <p>
                PRESTATIONS
              </p>
          ...
          <li class="nav-item {{ $active==5?'active':'' }}">
            <a href="/laboratoire/users" class="nav-link {{ $active==5?'active':'' }}">
