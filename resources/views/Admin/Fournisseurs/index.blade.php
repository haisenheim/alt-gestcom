                    ...
                    <table class="table table-bordered table-sm table-hover data-table">
                        ...
                        <tbody>
                            @foreach ($clients as $client)
                                <tr>
                                    <td> <a href="/admin/fournisseurs/{{ $client->id }}">{{ $client->name }}</a></td>
                                    <td>{{ $client->telephone }} / {{ $client->mobile }}</td>
                                    <td>{{ $client->email }}</td>
                                    <td>{{ $client->adresse }}</td>
                                    <th>{{ $client->factures->count() }}</th>
  ...
  <div class="modal fade" id="addFournisseur">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form enctype="multipart/form-data" method="POST" action="/admin/fournisseurs">
