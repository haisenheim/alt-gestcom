  ...
  <div class="">
        <div class="card card-light">
            <div class="card-header">
                <h5 class="card-title">HISTORIQUE DES FACTURES PROFORMA</h5>
                <div class="float-right">
                    <ul class="list-inline">
                        <li class="list-inline-item">
                            <button data-target="#addFacture" data-toggle="modal" class="btn btn-xs btn-success"><i class="fa fa-plus-circle" title="Ajouter une facture"></i> Nouvelle proforma</button>
                        </li>
                    </ul>
                </div>
            </div>
